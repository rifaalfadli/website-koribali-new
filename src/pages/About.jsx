...
const TeamCarousel = () => {
  ...
  const prev = () =>
    scrollToIndex(activeIndex === 0 ? totalSlides - 1 : activeIndex - 1);
  const next = () =>
    scrollToIndex(activeIndex === totalSlides - 1 ? 0 : activeIndex + 1);
  ...
  const values = [
    {
      icon: Target,
      title: "Presisi",
      desc: "Akurasi adalah harga mati dalam setiap kalkulasi struktur dan baris kode kami.",
    },
    {
      icon: Zap,
      title: "Inovasi",
      desc: "Terus mengadopsi teknologi terbaru untuk menghadirkan solusi yang lebih efisien.",
    },
    {
      icon: Shield,
      title: "Integritas",
      desc: "Transparansi dan standar etika tinggi dalam setiap pengerjaan proyek klien.",
    },
    {
      icon: Users,
      title: "Kolaborasi",
      desc: "Sinergi erat antara tim engineer kami dan stakeholder klien.",
    },
    {
      icon: Lightbulb,
      title: "Solutif",
      desc: "Fokus pada penyelesaian masalah, bukan sekadar penerapan teknologi.",
    },
    {
      icon: Code2,
      title: "Kualitas",
      desc: "Kode yang bersih dan struktur fisik yang kokoh sesuai standar nasional.",
    },
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Koribali adalah perusahaan Technology Consulting & AI Solutions yang menghadirkan transformasi digital, solusi AI, dan konsultasi teknologi engineering."
        />
      </Helmet>

      <PageHero
        title="Technology Consulting & AI Solutions untuk Bisnis yang Lebih Cerdas"
        description="Koribali hadir untuk memimpin transformasi digital bisnis Anda, mulai dari integrasi kecerdasan buatan dan digitalisasi sistem hingga konsultasi teknologi rekayasa yang presisi."
            ...
            <div className="lg:col-span-7 text-slate-600 dark:text-slate-300 space-y-6 leading-relaxed text-lg">
              <div className="mb-8">
                ...
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white font-display leading-tight">
                  <span className="text-blue-500">Technology Consulting</span> &
                  AI Solutions
                </h2>
              </div>

              <p>
                Koribali adalah perusahaan konsultan teknologi yang berfokus
                pada transformasi digital, kecerdasan buatan (AI), dan
                konsultasi teknologi engineering untuk menghadirkan solusi
                menyeluruh agar bisnis Anda beroperasi lebih cerdas dan efisien.
              </p>
              <p>
                Kami membangun segala kebutuhan digital Anda: dari aplikasi web
                custom dan digitalisasi sistem operasional manual, hingga
                integrasi LLM (Large Language Model) yang mengotomatisasi
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex flex-col gap-6">
              {galleryPhotos.slice(0, 3).map((photo) => (
                <div
                  key={photo.id}
                  className="relative group rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-slate-900 shadow-xl transition-all duration-500"
                >
