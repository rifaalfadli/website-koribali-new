      ...
      <section className="py-16 md:py-24 bg-slate-950">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="text-slate-300 space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-white mb-2">WAN Teknologi Internasional</h2>
              <p className="text-sm text-slate-400 mb-8">Terakhir diperbarui: 1 Januari 2026</p>
            </div>
            ...
            <h3 className="text-xl font-semibold text-white mt-8 mb-4">1. Ruang Lingkup Layanan</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-white mt-8 mb-4">2. Kewajiban Pengguna</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-white mt-8 mb-4">3. Hak Kekayaan Intelektual</h3>
            <p>
