...
const PegawaiProfile = () => {
  ...
  const [form, setForm] = useState({
    name: 'John Engineer',
    email: 'john@koribali.com',
    phone: '+62 812 3456 7890',
    address: 'Jl. Teknologi No. 10, Denpasar, Bali'
  });
  ...
  return (
    <>
      <Helmet>
        <title>Profil Saya | Koribali Portal</title>
      </Helmet>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-slate-400 text-sm">Kelola informasi pribadi dan pengaturan akun Anda.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 flex flex-col items-center text-center shadow-xl shadow-black/20 md:col-span-1 h-fit">
            ...
            <p className="text-blue-400 text-sm mb-4">Pegawai</p>
