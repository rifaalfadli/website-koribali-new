      ...
      <div className="pt-10">
        <SectionWrapper className="pt-0">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Form */}
            <div className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 md:p-10 shadow-xl">
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-6 font-display">Kirim Pesan</h3>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label htmlFor="name" className="block text-sm font-medium text-slate-600 dark:text-slate-400 mb-2">Nama Lengkap *</label>
                  <input
                    type="text"
                    id="name"
                    name="name"
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label htmlFor="whatsapp" className="block text-sm font-medium text-slate-600 dark:text-slate-400 mb-2">No. WhatsApp</label>
                    <input
                      type="tel"
                      id="whatsapp"
                      name="whatsapp"
                ...
                <div>
                  <label htmlFor="service" className="block text-sm font-medium text-slate-600 dark:text-slate-400 mb-2">Layanan yang Dibutuhkan</label>
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-slate-600 dark:text-slate-400 mb-2">Pesan Anda *</label>
                  <textarea
                    id="message"
                    name="message"
                    required
                    ...
                    onChange={handleChange}
                    className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors resize-none"
            ...
            <div className="flex flex-col space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6">
                  ...
                  <h4 className="text-slate-900 dark:text-white font-bold mb-2">Alamat Kantor</h4>
                  <p className="text-slate-500 dark:text-slate-400 text-sm">{company.address}</p>
                </div>
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6">
                  ...
                  <h4 className="text-slate-900 dark:text-white font-bold mb-2">Jam Operasional</h4>
                  <p className="text-slate-500 dark:text-slate-400 text-sm">{company.hours}</p>
                </div>
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm">{company.email}</p>
                </div>
              </div>
              ...
              {/* WhatsApp CTA */}
              <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 text-center flex flex-col items-center justify-center mt-6">
                <h4 className="text-slate-900 dark:text-white font-bold mb-2">
