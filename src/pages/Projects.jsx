      ...
      <div className="pt-10 bg-slate-950">
        ...
        <SectionWrapper className="pt-0">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-6">
            {visibleProjects.map((project) => (
              <Link to={`/project/${project.id}`} key={project.id} className="group cursor-pointer">
                <div className="bg-slate-900 border border-slate-800 rounded-[2rem] overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl h-full flex flex-col">
          ...
          {filteredProjects.length === 0 && (
            <div className="text-center py-20 text-slate-500 border border-slate-800 border-dashed rounded-2xl bg-slate-900/50">
          ...
          <SectionWrapper className="pt-0 pb-12">
            <div className="flex justify-center items-center space-x-2">
              <button
                ...
                className="w-10 h-10 rounded-full flex items-center justify-center bg-slate-900 text-slate-400 hover:bg-slate-800 hover:text-white transition-colors border border-slate-800 disabled:opacity-50 disabled:cursor-not-allowed hover:border-slate-700"
              >
