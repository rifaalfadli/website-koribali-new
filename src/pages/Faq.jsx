      ...
      <section className="py-16 md:py-24 bg-white dark:bg-slate-950">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="text-slate-600 dark:text-slate-300 space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Pertanyaan yang Sering Diajukan (FAQ)</h2>
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">1. Apa saja layanan utama yang ditawarkan oleh Koribali?</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">2. Bagaimana cara memulai kerja sama proyek dengan Koribali?</h3>
                <p className="text-slate-500 dark:text-slate-400">
              ...
              <div>
                <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">3. Apakah Koribali melayani klien di luar wilayah operasional utama?</h3>
                <p className="text-slate-500 dark:text-slate-400">
              ...
              <div>
                <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">4. Bagaimana proses dukungan purna jual (after-sales support) bekerja?</h3>
                <p className="text-slate-500 dark:text-slate-400">
