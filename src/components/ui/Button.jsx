...
const Button = ({ children, variant = 'primary', className = '', ...props }) => {
  ...
  const variants = {
    // Gradasi biru (sama di kedua mode)
    primary: "bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:from-blue-700 hover:to-blue-800 active:scale-95",

    // Border dan teks
    secondary: "border border-slate-300 dark:border-slate-600 text-slate-600 dark:text-slate-300 hover:border-blue-500 hover:text-blue-500 dark:hover:text-blue-400 active:scale-95",

    // Outline biru
    outline: "border-2 border-blue-700 text-blue-500 hover:bg-blue-500/10 active:scale-95",

    // Ghost
    ghost: "text-slate-600 dark:text-slate-300 hover:text-blue-500 dark:hover:text-blue-400 hover:bg-slate-100 dark:hover:bg-slate-800/80 active:scale-95"
  };
