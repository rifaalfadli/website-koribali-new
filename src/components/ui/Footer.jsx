        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4 pr-0 lg:pr-8">
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-6">
              Konsultan infrastruktur fisik dan IT profesional yang membantu
              bisnis mengembangkan solusi terintegrasi, aman, dan scalable untuk
              mendukung pertumbuhan dan transformasi teknologi Anda.
            </p>
            ...
            <div className="flex space-x-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-10 h-10 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:bg-blue-950 hover:text-blue-400 hover:border-blue-900/50 transition-all"
              >
