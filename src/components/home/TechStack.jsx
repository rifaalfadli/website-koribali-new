...
const TechStack = () => {
  ...
  return (
    <section className="w-full max-w-[100vw] lg:max-w-6xl mx-auto bg-white dark:bg-slate-950 py-20 overflow-hidden border-t border-slate-100 dark:border-slate-900/50">
      <div className="w-full px-4 md:px-8 mb-12 text-center">
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white font-display tracking-tight">
          Ekosistem Pengembangan Kami
        </h2>
        <p className="text-slate-500 dark:text-slate-400 mt-4 max-w-3xl mx-auto text-sm md:text-base">
          ...
          {[...techRow1, ...techRow1].map((tech, index) => (
            ...
            >
              ...
              <div className="flex flex-col text-left">
                ...
                <span className="text-slate-500 dark:text-slate-400 text-xs md:text-[13px]">
                  {tech.role}
                </span>
              </div>
            </div>
