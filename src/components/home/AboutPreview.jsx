...
const AboutPreview = () => {
  return (
    <SectionWrapper id="about-preview" className="bg-slate-950 overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white font-display leading-tight tracking-tight mb-6">
            Sinergi{' '}
          ...
          <p className="text-lg text-slate-300 leading-relaxed mb-4">
            <strong className="text-white">Koribali</strong> adalah perusahaan konsultan yang mengintegrasikan keahlian di bidang <strong className="text-white">teknik sipil</strong> dan <strong className="text-white">teknologi informasi</strong> dalam satu ekosistem yang utuh.
          </p>
          ...
          {pillars.map((pillar, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-slate-900 border border-slate-800 rounded-2xl p-6 flex items-start gap-5 group hover:border-blue-800/60 transition-all duration-300"
              >
                {/* Icon */}
                <div className="w-14 h-14 rounded-[1rem] bg-blue-800 flex items-center justify-center shrink-0">
                  <Icon className="w-7 h-7 text-white" strokeWidth={2} />
                </div>

                {/* Text */}
                <div>
                  <h3 className="text-lg font-bold text-white font-display tracking-tight mb-1 group-hover:text-blue-400 transition-colors">
                    {pillar.title}
                  </h3>
