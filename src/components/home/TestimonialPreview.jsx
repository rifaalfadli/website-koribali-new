...
const testimonials = [
  {
    ...
    quote:
      "Desain struktur dan kalkulasi beban dari tim Koribali sangat presisi. Membantu proyek jembatan kami lolos uji kelayakan dengan standar keamanan tertinggi.",
  },
  {
    id: 2,
    name: "Siska Maharani",
    ...
    quote:
      "Integrasi sistem web custom dengan Autodesk Inventor benar-benar menghemat waktu produksi kami hingga 40%. Sistemnya stabil dan sangat menunjang operasional kami.",
  },
  {
    id: 3,
    name: "Ahmad Rizky",
    ...
    quote:
      "Berkat dashboard analitik dari Koribali, kami bisa memonitor progres lapangan dan material secara real-time. Keputusan bisnis jadi jauh lebih akurat dan terukur.",
  },
  {
    id: 4,
    ...
    quote:
      "Perencanaan geometrik jalan dan drainase yang dibuat tim Koribali sangat efisien. Mereka sangat paham standar SNI dan menerapkannya dengan sempurna di lapangan.",
  },
  {
    id: 5,
    name: "Diana Larasati",
    ...
    quote:
      "Aplikasi manajemen aset yang dibangun Koribali membuat pelacakan armada dan perawatan mesin kami menjadi otomatis. Sangat profesional dan tepat waktu.",
  },
  {
    id: 6,
    name: "Reza Pratama",
    ...
    quote:
      "Sistem prediksi pemeliharaan berbasis AI yang mereka rancang sangat revolusioner. Kami kini bisa mendeteksi potensi kerusakan infrastruktur sebelum terjadi.",
  },
  {
    id: 7,
    name: "Faisal Akbar",
    ...
    quote:
      "Gambar kerja dan pemodelan 3D yang diberikan sangat aplikatif. Tim di lapangan tidak menemui kendala berarti saat melakukan fabrikasi dan ereksi baja.",
  },
  {
    id: 8,
    name: "Anita Wijaya",
    ...
    quote:
      "Pengembangan web app custom untuk manajemen inventory kami selesai lebih cepat dari target awal. User interface-nya intuitif dan mudah dipelajari oleh karyawan.",
  },
  {
    id: 9,
    ...
    quote:
      "Visualisasi data pergerakan tanah yang dirancang Koribali sangat informatif. Sangat membantu tim kami dalam mengambil keputusan mitigasi risiko struktural secara cepat.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 overflow-hidden">
        ...
        >
          {chunkedTestimonials.map((page, pageIndex) => (
            ...
            <div
              key={pageIndex}
              className="w-full min-w-full flex-shrink-0 flex-grow-0 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"
            >
              {page.map((item) => (
                <div
                  key={item.id}
