...
const workSteps = [
    { icon: MessageSquare, step: '01', title: 'Konsultasi & Analisis', desc: 'Diskusi awal untuk memahami kebutuhan spesifik, tantangan teknis, dan target proyek Anda.' },
    { icon: PenTool, step: '02', title: 'Perencanaan & Desain', desc: 'Tim ahli kami mulai merancang solusi arsitektur, kalkulasi beban, dan blueprint sistem.' },
    { icon: MonitorCheck, step: '03', title: 'Pengembangan & Eksekusi', desc: 'Fase konstruksi fisik atau penulisan kode software dengan kontrol kualitas yang ketat (SNI/ISO).' },
    { icon: CheckCircle, step: '04', title: 'Testing & Handover', desc: 'Pengujian menyeluruh sebelum serah terima, memastikan semuanya berjalan sempurna.' },
];
