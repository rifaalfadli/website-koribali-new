...
const TrustBar = () => {
  return (
    ...
    <div className="relative z-20 -mt-14 max-w-[960px] mx-auto px-4 md:px-8">
      ...
      <div className="bg-gradient-to-r from-red-800 to-red-950 rounded-[24px] lg:rounded-[40px] shadow-2xl shadow-red-950/40 py-4 sm:py-4 px-1 sm:px-4 md:px-6 lg:px-4">
